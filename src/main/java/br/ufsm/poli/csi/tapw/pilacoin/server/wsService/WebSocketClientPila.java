...
import br.ufsm.poli.csi.tapw.pilacoin.server.service.ValidaPilaCoinService;
...
public class WebSocketClientPila {
    ...
    static boolean onMineraPila = false;
    static boolean onValidaPila = false;

    public static void setOnMinerPila(boolean onMinerPila) {
        WebSocketClientPila.onMineraPila = onMinerPila;
    }

    public static void setOnValidaPila(boolean onValidaPila) {
        WebSocketClientPila.onValidaPila = onValidaPila;
    }
        ...
        while (onMineraPila) {
            if (sessionHandler.dificuldade != null) {
                ...
                PilaCoin pilaCoin = PilaCoin.builder()
                        ...
                        .chaveCriador(RegistraUsuarioService.getChavePublica().getEncoded())
                ...
                if (numHash.compareTo(sessionHandler.dificuldade) < 0) {
                    ...
                    if (numTent % 1000 == 0) {
                        System.out.println(numTent + " tentativas pilas");
                    }
                    numTent++;
                }
